...
#ifndef MY_INTERFACES__SRV__DETAIL__INPUT_REQUEST__FUNCTIONS_H_
#define MY_INTERFACES__SRV__DETAIL__INPUT_REQUEST__FUNCTIONS_H_
...
/// Initialize srv/InputRequest message.
/**
...
/// Finalize srv/InputRequest message.
/**
...
/// Create srv/InputRequest message.
/**
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * my_interfaces__srv__InputRequest_Request__init().
...
/// Destroy srv/InputRequest message.
/**
 * It calls
 * my_interfaces__srv__InputRequest_Request__fini()
...
/// Check for srv/InputRequest message equality.
/**
...
/// Copy a srv/InputRequest message.
/**
...
/// Initialize array of srv/InputRequest messages.
/**
...
/// Finalize array of srv/InputRequest messages.
/**
 * It calls
 * my_interfaces__srv__InputRequest_Request__fini()
...
/// Create array of srv/InputRequest messages.
/**
 * It allocates the memory for the array and calls
 * my_interfaces__srv__InputRequest_Request__Sequence__init().
 * \param[in] size The size / capacity of the array.
...
/// Destroy array of srv/InputRequest messages.
/**
 * It calls
 * my_interfaces__srv__InputRequest_Request__Sequence__fini()
 * on the array,
...
/// Check for srv/InputRequest message array equality.
/**
...
/// Copy an array of srv/InputRequest messages.
/**
 * This functions performs a deep copy, as opposed to the shallow copy that
 * plain assignment yields.
 *
 ...
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * my_interfaces__srv__InputRequest_Response__init().
 * \return The pointer to the initialized message if successful,
 * otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_my_interfaces
...
/**
 * It calls
 * my_interfaces__srv__InputRequest_Response__fini()
 * and frees the memory of the message.
 * \param[in,out] msg The allocated message pointer.
 */
ROSIDL_GENERATOR_C_PUBLIC_my_interfaces
...
/**
 * It allocates the memory for the array and calls
 * my_interfaces__srv__InputRequest_Response__Sequence__init().
 * \param[in] size The size / capacity of the array.
 * \return The pointer to the initialized array if successful, otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_my_interfaces
...
/**
 * It calls
 * my_interfaces__srv__InputRequest_Response__Sequence__fini()
 * on the array,
 * and frees the memory of the array.
 * \param[in,out] array The initialized array pointer.
 */
...
#endif  // MY_INTERFACES__SRV__DETAIL__INPUT_REQUEST__FUNCTIONS_H_
