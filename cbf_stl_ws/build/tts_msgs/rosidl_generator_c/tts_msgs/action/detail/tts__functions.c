...
tts_msgs__action__TTS_Goal__init(tts_msgs__action__TTS_Goal * msg)
{
  ...
  if (!rosidl_runtime_c__String__init(&msg->input)) {
    tts_msgs__action__TTS_Goal__fini(msg);
    return false;
  }
  // locale
  if (!rosidl_runtime_c__String__init(&msg->locale)) {
    tts_msgs__action__TTS_Goal__fini(msg);
    return false;
  }
  // voice
...
tts_msgs__action__TTS_Goal__fini(tts_msgs__action__TTS_Goal * msg)
{
  ...
  // locale
  rosidl_runtime_c__String__fini(&msg->locale);
  // voice
...
tts_msgs__action__TTS_Goal__create()
{
  ...
  tts_msgs__action__TTS_Goal * msg = (tts_msgs__action__TTS_Goal *)allocator.allocate(sizeof(tts_msgs__action__TTS_Goal), allocator.state);
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(tts_msgs__action__TTS_Goal));
  bool success = tts_msgs__action__TTS_Goal__init(msg);
  if (!success) {
...
tts_msgs__action__TTS_Goal__Sequence__init(tts_msgs__action__TTS_Goal__Sequence * array, size_t size)
{
  ...
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  tts_msgs__action__TTS_Goal * data = NULL;

  if (size) {
    data = (tts_msgs__action__TTS_Goal *)allocator.zero_allocate(size, sizeof(tts_msgs__action__TTS_Goal), allocator.state);
    if (!data) {
      return false;
    }
    ...
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = tts_msgs__action__TTS_Goal__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      ...
      for (; i > 0; --i) {
        tts_msgs__action__TTS_Goal__fini(&data[i - 1]);
      }
...
tts_msgs__action__TTS_Goal__Sequence__fini(tts_msgs__action__TTS_Goal__Sequence * array)
{
  ...
  if (array->data) {
    ...
    for (size_t i = 0; i < array->capacity; ++i) {
      tts_msgs__action__TTS_Goal__fini(&array->data[i]);
    }
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  tts_msgs__action__TTS_Goal__Sequence * array = (tts_msgs__action__TTS_Goal__Sequence *)allocator.allocate(sizeof(tts_msgs__action__TTS_Goal__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  bool success = tts_msgs__action__TTS_Goal__Sequence__init(array, size);
  if (!success) {
...
tts_msgs__action__TTS_Goal__Sequence__destroy(tts_msgs__action__TTS_Goal__Sequence * array)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (array) {
    tts_msgs__action__TTS_Goal__Sequence__fini(array);
  }
  allocator.deallocate(array, allocator.state);
}
...
tts_msgs__action__TTS_Goal__Sequence__are_equal(const tts_msgs__action__TTS_Goal__Sequence * lhs, const tts_msgs__action__TTS_Goal__Sequence * rhs)
{
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!tts_msgs__action__TTS_Goal__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
  ...
  tts_msgs__action__TTS_Goal__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(tts_msgs__action__TTS_Goal);
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    tts_msgs__action__TTS_Goal * data =
      (tts_msgs__action__TTS_Goal *)allocator.reallocate(
    ...
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!tts_msgs__action__TTS_Goal__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          tts_msgs__action__TTS_Goal__fini(&output->data[i]);
        }
        return false;
      }
    }
  ...
  for (size_t i = 0; i < input->size; ++i) {
    if (!tts_msgs__action__TTS_Goal__copy(
...
tts_msgs__action__TTS_Result__init(tts_msgs__action__TTS_Result * msg)
{
  ...
  if (!rosidl_runtime_c__String__init(&msg->error_msg)) {
    tts_msgs__action__TTS_Result__fini(msg);
    return false;
  }
  return true;
}
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  tts_msgs__action__TTS_Result * msg = (tts_msgs__action__TTS_Result *)allocator.allocate(sizeof(tts_msgs__action__TTS_Result), allocator.state);
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(tts_msgs__action__TTS_Result));
  bool success = tts_msgs__action__TTS_Result__init(msg);
  if (!success) {
    allocator.deallocate(msg, allocator.state);
    return NULL;
  }
...
tts_msgs__action__TTS_Result__Sequence__init(tts_msgs__action__TTS_Result__Sequence * array, size_t size)
{
  ...
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  tts_msgs__action__TTS_Result * data = NULL;

  if (size) {
    data = (tts_msgs__action__TTS_Result *)allocator.zero_allocate(size, sizeof(tts_msgs__action__TTS_Result), allocator.state);
    if (!data) {
      return false;
    }
    // initialize all array elements
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = tts_msgs__action__TTS_Result__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      // if initialization failed finalize the already initialized array elements
      for (; i > 0; --i) {
        tts_msgs__action__TTS_Result__fini(&data[i - 1]);
      }
      allocator.deallocate(data, allocator.state);
      return false;
    }
...
tts_msgs__action__TTS_Result__Sequence__fini(tts_msgs__action__TTS_Result__Sequence * array)
{
  ...
  if (array->data) {
    ...
    // finalize all array elements
    for (size_t i = 0; i < array->capacity; ++i) {
      tts_msgs__action__TTS_Result__fini(&array->data[i]);
    }
    allocator.deallocate(array->data, allocator.state);
    array->data = NULL;
    array->size = 0;
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  tts_msgs__action__TTS_Result__Sequence * array = (tts_msgs__action__TTS_Result__Sequence *)allocator.allocate(sizeof(tts_msgs__action__TTS_Result__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  bool success = tts_msgs__action__TTS_Result__Sequence__init(array, size);
  if (!success) {
    allocator.deallocate(array, allocator.state);
    return NULL;
  }
...
tts_msgs__action__TTS_Result__Sequence__destroy(tts_msgs__action__TTS_Result__Sequence * array)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (array) {
    tts_msgs__action__TTS_Result__Sequence__fini(array);
  }
  allocator.deallocate(array, allocator.state);
}
...
tts_msgs__action__TTS_Result__Sequence__are_equal(const tts_msgs__action__TTS_Result__Sequence * lhs, const tts_msgs__action__TTS_Result__Sequence * rhs)
{
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!tts_msgs__action__TTS_Result__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
  ...
  tts_msgs__action__TTS_Result__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(tts_msgs__action__TTS_Result);
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    tts_msgs__action__TTS_Result * data =
      (tts_msgs__action__TTS_Result *)allocator.reallocate(
      output->data, allocation_size, allocator.state);
    if (!data) {
      return false;
    }
    ...
    output->data = data;
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!tts_msgs__action__TTS_Result__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          tts_msgs__action__TTS_Result__fini(&output->data[i]);
        }
        return false;
      }
    }
  ...
  output->size = input->size;
  for (size_t i = 0; i < input->size; ++i) {
    if (!tts_msgs__action__TTS_Result__copy(
        &(input->data[i]), &(output->data[i])))
    {
      return false;
    }
...
tts_msgs__action__TTS_Feedback__init(tts_msgs__action__TTS_Feedback * msg)
{
  ...
  if (!rosidl_runtime_c__String__init(&msg->word)) {
    tts_msgs__action__TTS_Feedback__fini(msg);
    return false;
  }
  return true;
}
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  tts_msgs__action__TTS_Feedback * msg = (tts_msgs__action__TTS_Feedback *)allocator.allocate(sizeof(tts_msgs__action__TTS_Feedback), allocator.state);
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(tts_msgs__action__TTS_Feedback));
  bool success = tts_msgs__action__TTS_Feedback__init(msg);
  if (!success) {
    allocator.deallocate(msg, allocator.state);
    return NULL;
  }
...
tts_msgs__action__TTS_Feedback__Sequence__init(tts_msgs__action__TTS_Feedback__Sequence * array, size_t size)
{
  ...
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  tts_msgs__action__TTS_Feedback * data = NULL;

  if (size) {
    data = (tts_msgs__action__TTS_Feedback *)allocator.zero_allocate(size, sizeof(tts_msgs__action__TTS_Feedback), allocator.state);
    if (!data) {
      return false;
    }
    // initialize all array elements
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = tts_msgs__action__TTS_Feedback__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      // if initialization failed finalize the already initialized array elements
      for (; i > 0; --i) {
        tts_msgs__action__TTS_Feedback__fini(&data[i - 1]);
      }
      allocator.deallocate(data, allocator.state);
      return false;
    }
...
tts_msgs__action__TTS_Feedback__Sequence__fini(tts_msgs__action__TTS_Feedback__Sequence * array)
{
  ...
  if (array->data) {
    ...
    // finalize all array elements
    for (size_t i = 0; i < array->capacity; ++i) {
      tts_msgs__action__TTS_Feedback__fini(&array->data[i]);
    }
    allocator.deallocate(array->data, allocator.state);
    array->data = NULL;
    array->size = 0;
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  tts_msgs__action__TTS_Feedback__Sequence * array = (tts_msgs__action__TTS_Feedback__Sequence *)allocator.allocate(sizeof(tts_msgs__action__TTS_Feedback__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  bool success = tts_msgs__action__TTS_Feedback__Sequence__init(array, size);
  if (!success) {
    allocator.deallocate(array, allocator.state);
    return NULL;
  }
...
tts_msgs__action__TTS_Feedback__Sequence__destroy(tts_msgs__action__TTS_Feedback__Sequence * array)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (array) {
    tts_msgs__action__TTS_Feedback__Sequence__fini(array);
  }
  allocator.deallocate(array, allocator.state);
}
...
tts_msgs__action__TTS_Feedback__Sequence__are_equal(const tts_msgs__action__TTS_Feedback__Sequence * lhs, const tts_msgs__action__TTS_Feedback__Sequence * rhs)
{
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!tts_msgs__action__TTS_Feedback__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
  ...
  tts_msgs__action__TTS_Feedback__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(tts_msgs__action__TTS_Feedback);
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    tts_msgs__action__TTS_Feedback * data =
      (tts_msgs__action__TTS_Feedback *)allocator.reallocate(
      output->data, allocation_size, allocator.state);
    if (!data) {
      return false;
    }
    ...
    output->data = data;
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!tts_msgs__action__TTS_Feedback__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          tts_msgs__action__TTS_Feedback__fini(&output->data[i]);
        }
        return false;
      }
    }
  ...
  output->size = input->size;
  for (size_t i = 0; i < input->size; ++i) {
    if (!tts_msgs__action__TTS_Feedback__copy(
        &(input->data[i]), &(output->data[i])))
    {
      return false;
    }
...
tts_msgs__action__TTS_SendGoal_Request__init(tts_msgs__action__TTS_SendGoal_Request * msg)
{
  ...
  if (!unique_identifier_msgs__msg__UUID__init(&msg->goal_id)) {
    tts_msgs__action__TTS_SendGoal_Request__fini(msg);
    return false;
  }
  // goal
  if (!tts_msgs__action__TTS_Goal__init(&msg->goal)) {
    tts_msgs__action__TTS_SendGoal_Request__fini(msg);
    return false;
  }
  return true;
...
tts_msgs__action__TTS_SendGoal_Request__fini(tts_msgs__action__TTS_SendGoal_Request * msg)
{
  ...
  // goal
  tts_msgs__action__TTS_Goal__fini(&msg->goal);
}
...
tts_msgs__action__TTS_SendGoal_Request__are_equal(const tts_msgs__action__TTS_SendGoal_Request * lhs, const tts_msgs__action__TTS_SendGoal_Request * rhs)
{
  ...
  // goal
  if (!tts_msgs__action__TTS_Goal__are_equal(
      &(lhs->goal), &(rhs->goal)))
  {
    return false;
  }
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  tts_msgs__action__TTS_SendGoal_Request * msg = (tts_msgs__action__TTS_SendGoal_Request *)allocator.allocate(sizeof(tts_msgs__action__TTS_SendGoal_Request), allocator.state);
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(tts_msgs__action__TTS_SendGoal_Request));
  bool success = tts_msgs__action__TTS_SendGoal_Request__init(msg);
  if (!success) {
    allocator.deallocate(msg, allocator.state);
    return NULL;
  }
...
tts_msgs__action__TTS_SendGoal_Request__Sequence__init(tts_msgs__action__TTS_SendGoal_Request__Sequence * array, size_t size)
{
  ...
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  tts_msgs__action__TTS_SendGoal_Request * data = NULL;

  if (size) {
    data = (tts_msgs__action__TTS_SendGoal_Request *)allocator.zero_allocate(size, sizeof(tts_msgs__action__TTS_SendGoal_Request), allocator.state);
    if (!data) {
      return false;
    }
    // initialize all array elements
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = tts_msgs__action__TTS_SendGoal_Request__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      // if initialization failed finalize the already initialized array elements
      for (; i > 0; --i) {
        tts_msgs__action__TTS_SendGoal_Request__fini(&data[i - 1]);
      }
      allocator.deallocate(data, allocator.state);
      return false;
    }
...
tts_msgs__action__TTS_SendGoal_Request__Sequence__fini(tts_msgs__action__TTS_SendGoal_Request__Sequence * array)
{
  ...
  if (array->data) {
    ...
    // finalize all array elements
    for (size_t i = 0; i < array->capacity; ++i) {
      tts_msgs__action__TTS_SendGoal_Request__fini(&array->data[i]);
    }
    allocator.deallocate(array->data, allocator.state);
    array->data = NULL;
    array->size = 0;
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  tts_msgs__action__TTS_SendGoal_Request__Sequence * array = (tts_msgs__action__TTS_SendGoal_Request__Sequence *)allocator.allocate(sizeof(tts_msgs__action__TTS_SendGoal_Request__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  bool success = tts_msgs__action__TTS_SendGoal_Request__Sequence__init(array, size);
  if (!success) {
    allocator.deallocate(array, allocator.state);
    return NULL;
  }
...
tts_msgs__action__TTS_SendGoal_Request__Sequence__destroy(tts_msgs__action__TTS_SendGoal_Request__Sequence * array)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (array) {
    tts_msgs__action__TTS_SendGoal_Request__Sequence__fini(array);
  }
  allocator.deallocate(array, allocator.state);
}
...
tts_msgs__action__TTS_SendGoal_Request__Sequence__are_equal(const tts_msgs__action__TTS_SendGoal_Request__Sequence * lhs, const tts_msgs__action__TTS_SendGoal_Request__Sequence * rhs)
{
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!tts_msgs__action__TTS_SendGoal_Request__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
  ...
  tts_msgs__action__TTS_SendGoal_Request__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(tts_msgs__action__TTS_SendGoal_Request);
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    tts_msgs__action__TTS_SendGoal_Request * data =
      (tts_msgs__action__TTS_SendGoal_Request *)allocator.reallocate(
      output->data, allocation_size, allocator.state);
    if (!data) {
      return false;
    }
    ...
    output->data = data;
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!tts_msgs__action__TTS_SendGoal_Request__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          tts_msgs__action__TTS_SendGoal_Request__fini(&output->data[i]);
        }
        return false;
      }
    }
  ...
  output->size = input->size;
  for (size_t i = 0; i < input->size; ++i) {
    if (!tts_msgs__action__TTS_SendGoal_Request__copy(
        &(input->data[i]), &(output->data[i])))
    {
      return false;
    }
...
tts_msgs__action__TTS_SendGoal_Response__init(tts_msgs__action__TTS_SendGoal_Response * msg)
{
  ...
  if (!builtin_interfaces__msg__Time__init(&msg->stamp)) {
    tts_msgs__action__TTS_SendGoal_Response__fini(msg);
    return false;
  }
  return true;
}
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  tts_msgs__action__TTS_SendGoal_Response * msg = (tts_msgs__action__TTS_SendGoal_Response *)allocator.allocate(sizeof(tts_msgs__action__TTS_SendGoal_Response), allocator.state);
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(tts_msgs__action__TTS_SendGoal_Response));
  bool success = tts_msgs__action__TTS_SendGoal_Response__init(msg);
  if (!success) {
    allocator.deallocate(msg, allocator.state);
    return NULL;
  }
...
tts_msgs__action__TTS_SendGoal_Response__Sequence__init(tts_msgs__action__TTS_SendGoal_Response__Sequence * array, size_t size)
{
  ...
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  tts_msgs__action__TTS_SendGoal_Response * data = NULL;

  if (size) {
    data = (tts_msgs__action__TTS_SendGoal_Response *)allocator.zero_allocate(size, sizeof(tts_msgs__action__TTS_SendGoal_Response), allocator.state);
    if (!data) {
      return false;
    }
    // initialize all array elements
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = tts_msgs__action__TTS_SendGoal_Response__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      // if initialization failed finalize the already initialized array elements
      for (; i > 0; --i) {
        tts_msgs__action__TTS_SendGoal_Response__fini(&data[i - 1]);
      }
      allocator.deallocate(data, allocator.state);
      return false;
    }
...
tts_msgs__action__TTS_SendGoal_Response__Sequence__fini(tts_msgs__action__TTS_SendGoal_Response__Sequence * array)
{
  ...
  if (array->data) {
    ...
    // finalize all array elements
    for (size_t i = 0; i < array->capacity; ++i) {
      tts_msgs__action__TTS_SendGoal_Response__fini(&array->data[i]);
    }
    allocator.deallocate(array->data, allocator.state);
    array->data = NULL;
    array->size = 0;
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  tts_msgs__action__TTS_SendGoal_Response__Sequence * array = (tts_msgs__action__TTS_SendGoal_Response__Sequence *)allocator.allocate(sizeof(tts_msgs__action__TTS_SendGoal_Response__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  bool success = tts_msgs__action__TTS_SendGoal_Response__Sequence__init(array, size);
  if (!success) {
    allocator.deallocate(array, allocator.state);
    return NULL;
  }
...
tts_msgs__action__TTS_SendGoal_Response__Sequence__destroy(tts_msgs__action__TTS_SendGoal_Response__Sequence * array)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (array) {
    tts_msgs__action__TTS_SendGoal_Response__Sequence__fini(array);
  }
  allocator.deallocate(array, allocator.state);
}
...
tts_msgs__action__TTS_SendGoal_Response__Sequence__are_equal(const tts_msgs__action__TTS_SendGoal_Response__Sequence * lhs, const tts_msgs__action__TTS_SendGoal_Response__Sequence * rhs)
{
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!tts_msgs__action__TTS_SendGoal_Response__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
  ...
  tts_msgs__action__TTS_SendGoal_Response__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(tts_msgs__action__TTS_SendGoal_Response);
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    tts_msgs__action__TTS_SendGoal_Response * data =
      (tts_msgs__action__TTS_SendGoal_Response *)allocator.reallocate(
      output->data, allocation_size, allocator.state);
    if (!data) {
      return false;
    }
    ...
    output->data = data;
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!tts_msgs__action__TTS_SendGoal_Response__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          tts_msgs__action__TTS_SendGoal_Response__fini(&output->data[i]);
        }
        return false;
      }
    }
  ...
  output->size = input->size;
  for (size_t i = 0; i < input->size; ++i) {
    if (!tts_msgs__action__TTS_SendGoal_Response__copy(
        &(input->data[i]), &(output->data[i])))
    {
      return false;
    }
...
tts_msgs__action__TTS_GetResult_Request__init(tts_msgs__action__TTS_GetResult_Request * msg)
{
  ...
  // goal_id
  if (!unique_identifier_msgs__msg__UUID__init(&msg->goal_id)) {
    tts_msgs__action__TTS_GetResult_Request__fini(msg);
    return false;
  }
  return true;
}
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  tts_msgs__action__TTS_GetResult_Request * msg = (tts_msgs__action__TTS_GetResult_Request *)allocator.allocate(sizeof(tts_msgs__action__TTS_GetResult_Request), allocator.state);
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(tts_msgs__action__TTS_GetResult_Request));
  bool success = tts_msgs__action__TTS_GetResult_Request__init(msg);
  if (!success) {
    allocator.deallocate(msg, allocator.state);
    return NULL;
  }
...
tts_msgs__action__TTS_GetResult_Request__Sequence__init(tts_msgs__action__TTS_GetResult_Request__Sequence * array, size_t size)
{
  ...
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  tts_msgs__action__TTS_GetResult_Request * data = NULL;

  if (size) {
    data = (tts_msgs__action__TTS_GetResult_Request *)allocator.zero_allocate(size, sizeof(tts_msgs__action__TTS_GetResult_Request), allocator.state);
    if (!data) {
      return false;
    }
    // initialize all array elements
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = tts_msgs__action__TTS_GetResult_Request__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      // if initialization failed finalize the already initialized array elements
      for (; i > 0; --i) {
        tts_msgs__action__TTS_GetResult_Request__fini(&data[i - 1]);
      }
      allocator.deallocate(data, allocator.state);
      return false;
    }
...
tts_msgs__action__TTS_GetResult_Request__Sequence__fini(tts_msgs__action__TTS_GetResult_Request__Sequence * array)
{
  ...
  if (array->data) {
    ...
    // finalize all array elements
    for (size_t i = 0; i < array->capacity; ++i) {
      tts_msgs__action__TTS_GetResult_Request__fini(&array->data[i]);
    }
    allocator.deallocate(array->data, allocator.state);
    array->data = NULL;
    array->size = 0;
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  tts_msgs__action__TTS_GetResult_Request__Sequence * array = (tts_msgs__action__TTS_GetResult_Request__Sequence *)allocator.allocate(sizeof(tts_msgs__action__TTS_GetResult_Request__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  bool success = tts_msgs__action__TTS_GetResult_Request__Sequence__init(array, size);
  if (!success) {
    allocator.deallocate(array, allocator.state);
    return NULL;
  }
...
tts_msgs__action__TTS_GetResult_Request__Sequence__destroy(tts_msgs__action__TTS_GetResult_Request__Sequence * array)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (array) {
    tts_msgs__action__TTS_GetResult_Request__Sequence__fini(array);
  }
  allocator.deallocate(array, allocator.state);
}
...
tts_msgs__action__TTS_GetResult_Request__Sequence__are_equal(const tts_msgs__action__TTS_GetResult_Request__Sequence * lhs, const tts_msgs__action__TTS_GetResult_Request__Sequence * rhs)
{
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!tts_msgs__action__TTS_GetResult_Request__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
  ...
  tts_msgs__action__TTS_GetResult_Request__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(tts_msgs__action__TTS_GetResult_Request);
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    tts_msgs__action__TTS_GetResult_Request * data =
      (tts_msgs__action__TTS_GetResult_Request *)allocator.reallocate(
      output->data, allocation_size, allocator.state);
    if (!data) {
      return false;
    }
    ...
    output->data = data;
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!tts_msgs__action__TTS_GetResult_Request__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          tts_msgs__action__TTS_GetResult_Request__fini(&output->data[i]);
        }
        return false;
      }
    }
  ...
  output->size = input->size;
  for (size_t i = 0; i < input->size; ++i) {
    if (!tts_msgs__action__TTS_GetResult_Request__copy(
        &(input->data[i]), &(output->data[i])))
    {
      return false;
    }
...
tts_msgs__action__TTS_GetResult_Response__init(tts_msgs__action__TTS_GetResult_Response * msg)
{
  ...
  // status
  // result
  if (!tts_msgs__action__TTS_Result__init(&msg->result)) {
    tts_msgs__action__TTS_GetResult_Response__fini(msg);
    return false;
  }
  return true;
}
...
tts_msgs__action__TTS_GetResult_Response__fini(tts_msgs__action__TTS_GetResult_Response * msg)
{
  ...
  // status
  // result
  tts_msgs__action__TTS_Result__fini(&msg->result);
}
...
tts_msgs__action__TTS_GetResult_Response__are_equal(const tts_msgs__action__TTS_GetResult_Response * lhs, const tts_msgs__action__TTS_GetResult_Response * rhs)
{
  ...
  // result
  if (!tts_msgs__action__TTS_Result__are_equal(
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  tts_msgs__action__TTS_GetResult_Response * msg = (tts_msgs__action__TTS_GetResult_Response *)allocator.allocate(sizeof(tts_msgs__action__TTS_GetResult_Response), allocator.state);
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(tts_msgs__action__TTS_GetResult_Response));
  bool success = tts_msgs__action__TTS_GetResult_Response__init(msg);
  if (!success) {
    allocator.deallocate(msg, allocator.state);
    return NULL;
  }
...
tts_msgs__action__TTS_GetResult_Response__Sequence__init(tts_msgs__action__TTS_GetResult_Response__Sequence * array, size_t size)
{
  ...
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  tts_msgs__action__TTS_GetResult_Response * data = NULL;

  if (size) {
    data = (tts_msgs__action__TTS_GetResult_Response *)allocator.zero_allocate(size, sizeof(tts_msgs__action__TTS_GetResult_Response), allocator.state);
    if (!data) {
      return false;
    }
    // initialize all array elements
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = tts_msgs__action__TTS_GetResult_Response__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      // if initialization failed finalize the already initialized array elements
      for (; i > 0; --i) {
        tts_msgs__action__TTS_GetResult_Response__fini(&data[i - 1]);
      }
      allocator.deallocate(data, allocator.state);
      return false;
    }
...
tts_msgs__action__TTS_GetResult_Response__Sequence__fini(tts_msgs__action__TTS_GetResult_Response__Sequence * array)
{
  ...
  if (array->data) {
    ...
    // finalize all array elements
    for (size_t i = 0; i < array->capacity; ++i) {
      tts_msgs__action__TTS_GetResult_Response__fini(&array->data[i]);
    }
    allocator.deallocate(array->data, allocator.state);
    array->data = NULL;
    array->size = 0;
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  tts_msgs__action__TTS_GetResult_Response__Sequence * array = (tts_msgs__action__TTS_GetResult_Response__Sequence *)allocator.allocate(sizeof(tts_msgs__action__TTS_GetResult_Response__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  bool success = tts_msgs__action__TTS_GetResult_Response__Sequence__init(array, size);
  if (!success) {
    allocator.deallocate(array, allocator.state);
    return NULL;
  }
...
tts_msgs__action__TTS_GetResult_Response__Sequence__destroy(tts_msgs__action__TTS_GetResult_Response__Sequence * array)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (array) {
    tts_msgs__action__TTS_GetResult_Response__Sequence__fini(array);
  }
  allocator.deallocate(array, allocator.state);
}
...
tts_msgs__action__TTS_GetResult_Response__Sequence__are_equal(const tts_msgs__action__TTS_GetResult_Response__Sequence * lhs, const tts_msgs__action__TTS_GetResult_Response__Sequence * rhs)
{
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!tts_msgs__action__TTS_GetResult_Response__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
  ...
  tts_msgs__action__TTS_GetResult_Response__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(tts_msgs__action__TTS_GetResult_Response);
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    tts_msgs__action__TTS_GetResult_Response * data =
      (tts_msgs__action__TTS_GetResult_Response *)allocator.reallocate(
      output->data, allocation_size, allocator.state);
    if (!data) {
      return false;
    }
    ...
    output->data = data;
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!tts_msgs__action__TTS_GetResult_Response__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          tts_msgs__action__TTS_GetResult_Response__fini(&output->data[i]);
        }
        return false;
      }
    }
  ...
  output->size = input->size;
  for (size_t i = 0; i < input->size; ++i) {
    if (!tts_msgs__action__TTS_GetResult_Response__copy(
        &(input->data[i]), &(output->data[i])))
    {
      return false;
    }
...
tts_msgs__action__TTS_FeedbackMessage__init(tts_msgs__action__TTS_FeedbackMessage * msg)
{
  ...
  // goal_id
  if (!unique_identifier_msgs__msg__UUID__init(&msg->goal_id)) {
    tts_msgs__action__TTS_FeedbackMessage__fini(msg);
    return false;
  }
  // feedback
  if (!tts_msgs__action__TTS_Feedback__init(&msg->feedback)) {
    tts_msgs__action__TTS_FeedbackMessage__fini(msg);
    return false;
  }
  return true;
...
tts_msgs__action__TTS_FeedbackMessage__fini(tts_msgs__action__TTS_FeedbackMessage * msg)
{
  ...
  unique_identifier_msgs__msg__UUID__fini(&msg->goal_id);
  // feedback
  tts_msgs__action__TTS_Feedback__fini(&msg->feedback);
}
...
tts_msgs__action__TTS_FeedbackMessage__are_equal(const tts_msgs__action__TTS_FeedbackMessage * lhs, const tts_msgs__action__TTS_FeedbackMessage * rhs)
{
  ...
  // feedback
  if (!tts_msgs__action__TTS_Feedback__are_equal(
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  tts_msgs__action__TTS_FeedbackMessage * msg = (tts_msgs__action__TTS_FeedbackMessage *)allocator.allocate(sizeof(tts_msgs__action__TTS_FeedbackMessage), allocator.state);
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(tts_msgs__action__TTS_FeedbackMessage));
  bool success = tts_msgs__action__TTS_FeedbackMessage__init(msg);
  if (!success) {
    allocator.deallocate(msg, allocator.state);
    return NULL;
  }
...
tts_msgs__action__TTS_FeedbackMessage__Sequence__init(tts_msgs__action__TTS_FeedbackMessage__Sequence * array, size_t size)
{
  ...
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  tts_msgs__action__TTS_FeedbackMessage * data = NULL;

  if (size) {
    data = (tts_msgs__action__TTS_FeedbackMessage *)allocator.zero_allocate(size, sizeof(tts_msgs__action__TTS_FeedbackMessage), allocator.state);
    if (!data) {
      return false;
    }
    // initialize all array elements
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = tts_msgs__action__TTS_FeedbackMessage__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      // if initialization failed finalize the already initialized array elements
      for (; i > 0; --i) {
        tts_msgs__action__TTS_FeedbackMessage__fini(&data[i - 1]);
      }
      allocator.deallocate(data, allocator.state);
      return false;
    }
...
tts_msgs__action__TTS_FeedbackMessage__Sequence__fini(tts_msgs__action__TTS_FeedbackMessage__Sequence * array)
{
  ...
  if (array->data) {
    ...
    // finalize all array elements
    for (size_t i = 0; i < array->capacity; ++i) {
      tts_msgs__action__TTS_FeedbackMessage__fini(&array->data[i]);
    }
    allocator.deallocate(array->data, allocator.state);
    array->data = NULL;
    array->size = 0;
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  tts_msgs__action__TTS_FeedbackMessage__Sequence * array = (tts_msgs__action__TTS_FeedbackMessage__Sequence *)allocator.allocate(sizeof(tts_msgs__action__TTS_FeedbackMessage__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  bool success = tts_msgs__action__TTS_FeedbackMessage__Sequence__init(array, size);
  if (!success) {
    allocator.deallocate(array, allocator.state);
    return NULL;
  }
...
tts_msgs__action__TTS_FeedbackMessage__Sequence__destroy(tts_msgs__action__TTS_FeedbackMessage__Sequence * array)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (array) {
    tts_msgs__action__TTS_FeedbackMessage__Sequence__fini(array);
  }
  allocator.deallocate(array, allocator.state);
}
...
tts_msgs__action__TTS_FeedbackMessage__Sequence__are_equal(const tts_msgs__action__TTS_FeedbackMessage__Sequence * lhs, const tts_msgs__action__TTS_FeedbackMessage__Sequence * rhs)
{
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!tts_msgs__action__TTS_FeedbackMessage__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
  ...
  tts_msgs__action__TTS_FeedbackMessage__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(tts_msgs__action__TTS_FeedbackMessage);
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    tts_msgs__action__TTS_FeedbackMessage * data =
      (tts_msgs__action__TTS_FeedbackMessage *)allocator.reallocate(
      output->data, allocation_size, allocator.state);
    if (!data) {
      return false;
    }
    ...
    output->data = data;
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!tts_msgs__action__TTS_FeedbackMessage__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          tts_msgs__action__TTS_FeedbackMessage__fini(&output->data[i]);
        }
        return false;
      }
    }
  ...
  output->size = input->size;
  for (size_t i = 0; i < input->size; ++i) {
    if (!tts_msgs__action__TTS_FeedbackMessage__copy(
        &(input->data[i]), &(output->data[i])))
    {
      return false;
    }
